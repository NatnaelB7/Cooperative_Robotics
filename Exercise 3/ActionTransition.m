...
if (ismember(taskname, previous) == 0 && ismember(taskname, current) && taskname == "MM")
    A = 1;   % MM task becomes active instantly
elseif ((ismember(taskname, previous) && ismember(taskname, current) == 0) && taskname == "MM")
    A = 0;   % MM task becomes inactive instantly
